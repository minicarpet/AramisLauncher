...
namespace AramisLauncher.JSON
{
    ...
    public partial class AramisPackageJson
    {
        public static AramisPackageJson FromJson(string json) => JsonConvert.DeserializeObject<AramisPackageJson>(json, AramisLauncher.JSON.AramisPackageJsonConverter.Settings);
    }

    public static class AramisPackageJsonSerialize
    {
        public static string ToJson(this AramisPackageJson self) => JsonConvert.SerializeObject(self, AramisLauncher.JSON.AramisPackageJsonConverter.Settings);
    }

    internal static class AramisPackageJsonConverter
    {
